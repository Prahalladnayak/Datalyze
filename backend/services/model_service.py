...
def train_and_evaluate(df: pd.DataFrame, target_col: str, task_type: str, perform_eda: bool = False):
    ...
    for name, model in models.items():
        ...
        try:
            ...
            if is_classification:
                # Average micro/macro handles multiclass vs binary gracefully; using weighted for robustness
                try:
                ...
                if acc is not None and acc > best_score:
                    ...
                    try:
                        # Convert matrix logic for UI. Simplified to binary visualization if binary.
